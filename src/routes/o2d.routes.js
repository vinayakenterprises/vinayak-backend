...
router.get(
  "/retrieve-customer-by-id/:id",
  authMiddleware,
  o2dController.retrieveCustomerDetailsById
);
router.put(
  "/update-existing-customer/:id",
  authMiddleware,
  o2dController.updateExistingCustomerDetails
);
...
router.get(
  "/get-credit-limit-reached-data",
  authMiddleware,
  o2dController.getCreditLimitReachedData
);
router.post(
  "/approve-credit-limit-exceeded-sale",
  authMiddleware,
  o2dController.approveCreditLimitExceededSale
);
...
router.get(
  "/get-so-generation-request-data",
  authMiddleware,
  o2dController.getSOGenerationRequestData
);
router.post(
  "/complete-so-generation-request",
  authMiddleware,
  o2dController.completeSOGenerationRequest
);
router.get(
  "/get-completed-so-generation-request-data",
  authMiddleware,
  o2dController.getCompletedSOGenerationRequestData
);
...
router.post(
  ...
  authMiddleware,
  o2dController.updateDispatchInformation
);
router.post("/assign-to-vehicle-executive", authMiddleware, o2dController.assignToVehicleExecutive);
router.post(
  "/assign-order-to-invoice-executive",
  authMiddleware,
  o2dController.assignOrderToInvoiceExecutive
);
router.post(
  "/intimation-and-thank-you-data-update",
  authMiddleware,
  o2dController.intimationAndThankYouData
);
router.post("/update-payment-information", authMiddleware, o2dController.updatePaymentInformation);
router.post(
  "/update-delivery-and-weight-information",
  authMiddleware,
  o2dController.updateDeliveryAndWeightInformation
);
...
router.put(
  "/sale-orders/:id/remarks/:remarkId",
  authMiddleware,
  o2dController.updateRemarksForOrder
);
router.delete(
  "/sale-orders/:id/remarks/:remarkId",
  authMiddleware,
  o2dController.deleteRemarksForOrder
);
router.post(
  "/get-specific-sale-order-information",
  authMiddleware,
  o2dController.getSpecificSaleOrderInformation
);
router.post(
  "/split-order-into-multiple-orders",
  authMiddleware,
  o2dController.splitOrderIntoMultipleOrders
);

// vehicle arrange phase
router.get(
  "/get-vehicle-executive-assigned-data",
  authMiddleware,
  o2dController.getVehicleExecutiveAssignedData
);
router.get(
  "/vehicle-executive-work-history",
  authMiddleware,
  o2dController.getVehicleExecutiveWorkHistory
);
router.post(
...
router.get(
  ...
  authMiddleware,
  o2dController.getInvoiceGenerationRequestData
);
router.post(
  "/update-invoice-and-dispatch-info",
  authMiddleware,
  o2dController.updateInvoiceAndDispatchInfo
);
router.get(
  "/get-invoice-executive-completed-data",
  authMiddleware,
  o2dController.getInvoiceExecutiveCompletedData
);
...
router.post(
  "/update-callaction-information",
  authMiddleware,
  o2dController.updateCallActionInformation
);
...
router.post(
  "/complaint-closure-info-update",
  authMiddleware,
  o2dController.updateComplaintClosureInformation
);
...
router.get(
  "/get-interest-note-issue-work-history",
  authMiddleware,
  o2dController.getInterestNoteIssueWorkHistory
);
router.get(
  "/get-uncollected-interest-note-data",
  authMiddleware,
  o2dController.getUncollectedInterestNoteData
);
...
router.get(
  ...
  authMiddleware,
  o2dController.getAdminDashboardCardsData
);
router.post(
  "/get-all-sale-orders-admin-dashboard",
  authMiddleware,
  o2dController.getActiveSaleOrdersAdminDashboard
);
...
router.post(
  ...
  authMiddleware,
  o2dController.updateOverdueSummaryReportInformation
);
...
router.post(
  "/invoice-details-from-tally",
  documentUpload,
  o2dController.receiveInvoiceDetailsFromTally
);
router.post(
  "/get-credit-debit-note-from-tally",
  documentUpload,
  o2dController.getCreditDebitNoteFromTally
);
router.post(
  "/interest-note-details-from-tally",
  documentUpload,
  o2dController.receiveInterestNoteDetailsFromTally
);
...
router.post("/invoice-pdf-url-update", authMiddleware, o2dController.updateInvoicePdfUrl);

// sales team dashboard
router.get(
  "/sales-team-dashboard-pending-orders-data",
  authMiddleware,
  o2dController.getSalesTeamDashboardPendingOrdersData
);
router.get(
  "/sales-team-dashboard-delay-dispatch-till-date",
  authMiddleware,
  o2dController.getSalesTeamDashboardDelayDispatchTillDate
);
router.get(
  "/sales-team-dashboard-pending-dispatch-overview",
  authMiddleware,
  o2dController.getSalesTeamDashboardPendingDispatchOverview
);
